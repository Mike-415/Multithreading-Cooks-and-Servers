...
public class FoodTester {
	...
	public static void main(String[] args) {
		...
		BlockingQueue<Food> orderQueue = new ArrayBlockingQueue<Food>(3);
		Thread cooker = new Thread(new CookThread(orderQueue, foodList));
		Thread server = new Thread(new ServeThread(orderQueue, foodList));
		cooker.start();
		server.start();
